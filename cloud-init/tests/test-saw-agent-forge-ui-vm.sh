...
grep -Fq 'forge_ui_registry_server: ""' "$agent_vars"
grep -Fq 'forge_ui_registry_username: ""' "$agent_vars"
grep -Fq 'forge_ui_registry_password: ""' "$agent_vars"
...
grep -Fq 'forge_ui_registry_server_cfg: "{{ forge_ui_registry_server | default(\"\") }}"' "$agent_playbook"
grep -Fq 'Validate Forge UI registry auth when provided' "$agent_playbook"
grep -Fq 'Authenticate rootless Podman for Forge UI image registry' "$agent_playbook"
...
grep -Fq 'Read Forge UI service status' "$agent_playbook"
grep -Fq 'Read Forge UI service journal' "$agent_playbook"
grep -Fq 'Inspect Forge UI podman container' "$agent_playbook"
